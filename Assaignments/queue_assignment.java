...
public class queue_assignment {
    public static void main(String[] args) {
        ...
        while (true) { 
            ...
            if(w==2){ 
                Document.poll();
                System.out.println("DOCUMENT IN QUEUE DELETED");
            }
            if(w==3){ 
                if(Document.isEmpty()){System.out.println("DOCUMENT IS EMPTY");}else{System.out.println("DOCUMENT IS NOT EMPTY");}
            }
            if(w==4){ 
